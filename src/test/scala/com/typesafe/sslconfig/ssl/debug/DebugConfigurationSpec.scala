...
object DebugConfigurationSpec extends Specification with After {
  ...
  val internalDebugLogger = org.slf4j.LoggerFactory.getLogger("com.typesafe.sslconfig.ssl.debug.FixInternalDebugLogging")
  val certpathDebugLogger = org.slf4j.LoggerFactory.getLogger("com.typesafe.sslconfig.ssl.debug.FixCertpathDebugLogging")
