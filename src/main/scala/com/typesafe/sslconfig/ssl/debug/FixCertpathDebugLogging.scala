...
object FixCertpathDebugLogging {
  ...
  val logger = org.slf4j.LoggerFactory.getLogger("com.typesafe.sslconfig.ssl.debug.FixCertpathDebugLogging")

  class MonkeyPatchSunSecurityUtilDebugAction(val newDebug: Debug, val newOptions: String) extends FixLoggingAction {
    val logger = org.slf4j.LoggerFactory.getLogger("com.typesafe.sslconfig.ssl.debug.FixCertpathDebugLogging.MonkeyPatchSunSecurityUtilDebugAction")
